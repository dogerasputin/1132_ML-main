...
def get_args_parser():
    ...
    parser.add_argument('--nb-classes', default=1000, type=int, help='number of output classes')
...
def main(args):
    ...
    dataset_train, inferred_classes = build_dataset(is_train=True, args=args)
    if not hasattr(args, 'nb_classes') or args.nb_classes is None:
        args.nb_classes = inferred_classes
    print(f"Using nb_classes = {args.nb_classes}")
